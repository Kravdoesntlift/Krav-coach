...
export default function LoginPage() {
  ...
  // Show friendly message if redirected here after an expired link
  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    const err = params.get("error");
    if (err === "link_expirado") {
      setError("O link expirou ou já foi usado. Pede um novo link de recuperação.");
    }
  }, []);
      ...
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 1px 0 rgba(255,255,255,0.06) inset, 0 32px 64px rgba(0,0,0,0.5), 0 0 0 1px rgba(0,0,0,0.2)",
          }}
        >
          <div>
            <h2 className="text-white text-xl font-bold tracking-tight">Bem-vindo de volta</h2>
            <p className="text-zinc-500 text-sm mt-0.5">Entra para continuar o teu progresso</p>
          </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-zinc-600 hover:text-brand-gold text-xs transition-colors"
                >
